 ...
 * Generated on 1/6/2026, 7:31:40 PM
...
window.effectsProConfig = {
  ...
  themes: {
    ...
    halloween: {
      ...
      ghostSizeMin: 90,
      ghostSizeMax: 120,
      ghostDirection: "mixed",
      ghostRandomness: 0.78,
    },
    christmasLights: {
    ...
    flowers: {
      ...
      cssOnly: true,
      style: "ellipse",
      spawnMode: "bottomBand",
      spawnRatePerSec: 0.65,
      initialBurst: 3,
      maxFlowers: 30,
      xPaddingPercent: 0.5,
      yMinPercent: 56,
      ...
      stemAlpha: 0.9,
      stemGlowBlur: 5,
      petalGlowBlurFront: 51,
      petalGlowBlurBack: 15,
      centerGlowBlur: 20,
      petalHighlightAlpha: 0.55,
    ...
    water: {
      ...
      emissionRate: 26,
      maxParticles: 220,
      colors: ["rgba(125,211,252,0.85)", "rgba(14,165,233,0.75)", "rgba(56,189,248,0.85)"],
      speedMin: 380,
      speedMax: 720,
      lengthMin: 16,
      lengthMax: 34,
  ...
  resetAnimationsToken: 1767717326643,
};

console.warn("✅ Effects Pro config loaded");
